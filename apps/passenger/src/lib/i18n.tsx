...
export const strings = {
  en: {
    ...
    nearYou: "Near You",
    searchOriginPlaceholder: "Search origin stop…",
    typeDestinationPlaceholder: "Type destination stop (e.g., Bus Stand)…",
    matchingTransitStops: "Matching Transit Stops",
    checkingConnectingLines: "Checking connecting bus lines…",
    departurePoint: "Departure Point",
    districtNetwork: "District Network",
    ...
    description: "Complaint Message / Details",
    descPlaceholder: "Please describe what happened in detail so administrators can investigate and resolve…",
  ...
  ta: {
    ...
    from: "இருந்து",
    to: "வரை",
    fromLocation: "புறப்படும் இடம் (உங்கள் இருப்பிடம்)",
    toDestination: "சேருமிடம் (இலக்கு நிறுத்தம்)",
    detectGps: "இருப்பிடம் கண்டறி",
    locating: "கண்டறியப்படுகிறது…",
    change: "மாற்று",
    done: "முடிந்தது",
    nearYou: "உங்கள் அருகில்",
    searchOriginPlaceholder: "புறப்படும் நிறுத்தத்தைத் தேடுக…",
    typeDestinationPlaceholder: "சேருமிடத்தைத் தேடுக (எ.கா. பேருந்து நிலையம்)…",
    matchingTransitStops: "பொருத்தமான பேருந்து நிறுத்தங்கள்",
    checkingConnectingLines: "இணைப்புப் பேருந்துகள் சரிபார்க்கப்படுகின்றன…",
    departurePoint: "புறப்படும் இடம்",
    districtNetwork: "மாவட்ட பொதுப்போக்குவரத்து",
    ...
    description: "புகார் விவரம் / உங்கள் செய்தி (Complaint Message)",
    descPlaceholder: "நடந்த சம்பவத்தை விரிவாக விவரிக்கவும் (அதிகாரிகள் நடவடிக்கை எடுக்க ஏதுவாக)…",
...
export const passengerDictionary: Record<string, string> = {
  ...
  // Permanent UI Controls, Headers & Badges (Hardcoded Authentic Tamil)
  ...
  "DETECT GPS": "இருப்பிடம் கண்டறி",
  "Detect GPS Save": "இருப்பிடம் கண்டறி",
  "Detect GPS save": "இருப்பிடம் கண்டறி",
  "Locating…": "கண்டறியப்படுகிறது…",
  "Locating...": "கண்டறியப்படுகிறது…",
  "Locating nearest stop…": "அருகிலுள்ள நிறுத்தம் கண்டறியப்படுகிறது…",
  "Locating you…": "உங்கள் இருப்பிடம் கண்டறியப்படுகிறது…",
  "Change": "மாற்று",
  "Done": "முடிந்தது",
  "From (Your Location)": "புறப்படும் இடம் (உங்கள் இருப்பிடம்)",
  "From (YOUR LOCATION)": "புறப்படும் இடம் (உங்கள் இருப்பிடம்)",
  "from (your location)": "புறப்படும் இடம் (உங்கள் இருப்பிடம்)",
  "To (Destination Stop)": "சேருமிடம் (இலக்கு நிறுத்தம்)",
  "To (DESTINATION STOP)": "சேருமிடம் (இலக்கு நிறுத்தம்)",
  "to (destination stop)": "சேருமிடம் (இலக்கு நிறுத்தம்)",
  "Your Location": "உங்கள் இருப்பிடம்",
  "YOUR LOCATION": "உங்கள் இருப்பிடம்",
  "your location": "உங்கள் இருப்பிடம்",
  "Destination Stop": "இலக்கு நிறுத்தம்",
  "DESTINATION STOP": "இலக்கு நிறுத்தம்",
  "destination stop": "இலக்கு நிறுத்தம்",
  ...
  "ORIGIN": "புறப்படும் இடம்",
  "origin": "புறப்படும் இடம்",
  "Departure Point": "புறப்படும் இடம்",
  "Type destination stop": "சேருமிடத்தைத் தட்டச்சு செய்க",
  "Type destination stop (e.g., Fish Market)…": "சேருமிடத்தைத் தேடுக (எ.கா. பேருந்து நிலையம்)…",
  "Type destination stop (e.g., Bus Stand)…": "சேருமிடத்தைத் தேடுக (எ.கா. பேருந்து நிலையம்)…",
  "Type destination stop (e.g., Fish Market)...": "சேருமிடத்தைத் தேடுக (எ.கா. பேருந்து நிலையம்)…",
  "Type destination stop (e.g., Bus Stand)...": "சேருமிடத்தைத் தேடுக (எ.கா. பேருந்து நிலையம்)…",
  "Search origin stop…": "புறப்படும் நிறுத்தத்தைத் தேடுக…",
  "Search origin stop...": "புறப்படும் நிறுத்தத்தைத் தேடுக…",
  "Matching Transit Stops": "பொருத்தமான பேருந்து நிறுத்தங்கள்",
  "Checking connecting bus lines…": "இணைப்புப் பேருந்துகள் சரிபார்க்கப்படுகின்றன…",
  "Checking connecting bus lines...": "இணைப்புப் பேருந்துகள் சரிபார்க்கப்படுகின்றன…",
  "Swap Origin and Destination": "புறப்படும் மற்றும் சேருமிடத்தை மாற்றுக",
  "District Network": "மாவட்ட பொதுப்போக்குவரத்து",
  "DISTRICT NETWORK": "மாவட்ட பொதுப்போக்குவரத்து",
  "District Transit Network": "மாவட்ட பொதுப்போக்குவரத்து",
  "Transit Network": "பொதுப்போக்குவரத்து",
  "Transit Stop": "பேருந்து நிறுத்தம்",
  ...
  "Type": "வகை",
  "Concession": "சலுகை",
  "Fare paid": "செலுத்தப்பட்ட கட்டணம்",
  "Valid until": "செல்லuபடியாகும் நேரம்",
  "Status": "நிலை",
  "m away (GPS)": "மீ தூரத்தில் (GPS)",

  // Major Tamil Nadu Transit Districts
  "Chennai": "சென்னை",
  "CHENNAI": "சென்னை",
...
export const coreEnglishWordsBlocklist = new Set([
  ...
  "until", "board", "boarding", "alighting", "help", "sos"
]);
