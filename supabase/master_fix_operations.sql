...
begin
  ...
  -- 4. Calculate ticket aggregates for this conductor on target date or active trip
  select
...
-- 18. Schema Expansion for Live Adherence & Spatial Telemetry
alter table public.trips
...
-- 19. Schedule Adherence & Delay Classification Engine (Compares Polled Conductor Phone GPS vs Stop Coordinates)
...
-- 20. Batch Evaluation for All Active Trips in Fleet
...
-- 21. Unified Automated Trigger on GPS Logs: Stop Progression + Schedule Adherence Engine
...
-- =============================================================================
-- EMERGENCY SOS & PASSENGER ⇄ ADMIN LIVE BIDIRECTIONAL CHAT
-- =============================================================================
...
begin
  ...
  -- 5. Spawn emergency alert for control room with linked chat_id
  insert into alerts (
    trip_id,
    bus_id,
    district_id,
