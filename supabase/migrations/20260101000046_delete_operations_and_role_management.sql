-- =============================================================================
-- 046: Delete Operations & Dynamic Role Management RPCs
--
-- 1. delete_district: Safely unlinks routes, buses, conductors, trips, and admins
--    before deleting the district record.
-- 2. delete_conductor: Unlinks conductor from trips, unassigns active ETMs,
--    and purges conductor, profile, and auth records safely.
-- 3. delete_admin_user: Allows administrators to delete admin accounts with
--    self-deletion guard and hierarchy protection.
-- 4. update_district_admin_profile: Enhanced with role modification/revocation.
-- 5. RLS policies adjusted to allow is_any_admin() delete operations.
-- =============================================================================
...
begin
  ...
  if v_user_id is not null then
    ...
    exception when others then
      -- Do not block conductor deletion if auth.users has cascading constraints
      null;
    end;
  end if;
